# 9.17 Aumente o widget de calculadora Calc de modo que o usuário possa
# digitar teclas do teclado em vez de clicar botões
# correspondentes aos 10 dígitos, o ponto e os operadores +, –, * e /.
# Também permita que o usuário digite a tecla Enter/Return em
# vez de clicar no botão rotulado com =.
